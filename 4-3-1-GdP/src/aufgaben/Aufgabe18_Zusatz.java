...
public class Aufgabe18_Zusatz {
	 ...
	 * 
	 * 
	 * Zusatz Aufgabe: Erstelle eine eigene Exeption 
	 */
	...
	public static long sum (int n) {
		if (n<=0) {
			throw new NegativeNumberExeption("Der Parameter n darf nicht kleiner als 1 sein!");
		}
		int summe = 0;
		for (int i = 1 ; i <= n ;i++) {
			summe += i;
	...
	static class NegativeNumberExeption extends IllegalArgumentException {
		NegativeNumberExeption () {
			super();
		}
		NegativeNumberExeption (String msg) {
			super(msg);
		}
	}
}
